    ...
    <div class="nbd-color-palette-inner">
        <div class="working-palette" ng-hide="settings.hideColorPalette">
            ...
            <ul class="main-color-palette nbd-perfect-scroll">
                ...
                <li class="color-eyedropper" ng-click="initEyeDropper($event, true)" title="<?php esc_html_e('Eyedropper','web-to-print-online-designer'); ?>" ng-if="settings['nbdesigner_enable_eyedropper'] == 'yes'">
