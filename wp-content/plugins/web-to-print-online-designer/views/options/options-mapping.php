...
<div id="nbo_mapping" class="panel nbo_mapping woocommerce_options_panel wc-metaboxes-wrapper hidden">
    ...
    <div class="options_group" id="nbo_maps_wrap">
        ...
        <?php else: ?>
        <p><?php _e( 'Add a at least one attribute / variation combination to this product that has been mapped with "Print options" fields. Enable print options for this product <a href="#nbo-options">here</a>. After you add the attributes from the "Attributes" tab and create a variation, save the product, maybe create new "Printing options" and comeback here you will see the print options mapping here.', 'web-to-print-online-designer' ); ?></p>
        <?php endif; ?>
    </div>
</div>
