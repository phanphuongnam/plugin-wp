            ...
            <?php foreach ( $designs as $design ) { ?>
                <tr class="order">
                    ...
                    <td data-title="<?php esc_html_e('Action', 'web-to-print-online-designer'); ?>">
                        ...
                        ?>
                        <a class="woocommerce-button button edit nbdl-edit" data-design-id="<?php echo $design['id']; ?>" data-product-id="<?php echo $design['product']['product_id']; ?>" href="<?php echo $link_edit_design; ?>"><?php esc_html_e('Edit', 'web-to-print-online-designer'); ?></a>
                        <?php 
