...
//            }, 100);
    ...
    $scope.createPreviewWidthClippath = function( index, callback ){
        ...
        _.each($scope.stages, function(stage, index){
            ...
            if( angular.isDefined( $scope.areaDesignZoomedClipPaths[index] ) && $scope.areaDesignZoomedClipPaths[index] && !downloadType ){
                $timeout(function(){
                    ...
                    var newSvg = stage.svg.replace('<\/defs>', clipPath + '<\/defs><g clip-path="url(#area-design-shape-' + index + ')">');
                    newSvg = newSvg.replace('<\/svg>', '<\/g><\/svg>');
                    stage.svg = newSvg;
                    $scope.createPreviewWidthClippath( index, function(){
...
//        }
    ...
    $scope.processAreaDesignShape = function(index){
        ...
        function getTranslationAndScaling( origPathBoundingBox, svgWdth, svgHght ) {
            ...
            if( origPathWdth == 0 ) return { pathTranslX: 0, pathTranslY: 0, scale: 1 };
            ...
            return { pathTranslX: pathTranslX, pathTranslY: pathTranslY, scale: scale };
        }
        ...
        $timeout(function(){
            ...
            _viewBox = $scope.areaDesignShapes[index].match(/viewBox="(.*?)"/)[1],
